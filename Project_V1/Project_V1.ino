...
void loop() {
 ...
 // Serial.print("Temperature = "); Serial.print(temperature); Serial.print(" PID output = "); Serial.println(outputVal);

  temp_string = String(temperature);
  PID_string = String(outputVal/10);
  //delay(100); // don't use delay or the button logic won't work.
}
